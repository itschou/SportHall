...
<main class="">
    ...
    <div class="container">
        <h1 class="welcome text-center">
            <span class="welcome">{{ config()->get('config.basics.nom')}}</span>
        </h1>
        <h3 class="welcome text-center">
            <span class="welcome">Votre salle de sport !</span>
            <span class="welcome">Votre bien être !</span>
            <span class="welcome">Votre transformation !</span>
    ...
    <div class="container-fluid">
        ...
        <iframe src="https://www.google.com/{{config()->get('config.basics.map')}}" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
