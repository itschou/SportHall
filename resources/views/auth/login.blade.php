    ...
    <div class="container">
        <div class="row justify-content-center">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('login.custom') }}">
                            ...
                            <div class="d-grid mx-auto">
                                <button type="submit" class="btn text-white" style="background-color:  <?php echo $secondaryColor ?>;">{{ config()->get('config.basics.login') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="100%" height="100%" viewBox="0 0 869.99994 520.13854" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <circle cx="524.99994" cy="335.5" r="16" fill="<?php echo $secondaryColor ?>" />
                    ...
                    <path d="M814.17958,522.54937H740.13271l.08911-.57617c.13306-.86133,13.19678-86.439,3.56177-114.436a11.813,11.813,0,0,1,6.06933-14.5835h.00025c13.77173-6.48535,40.20752-14.47119,62.52,4.90918a28.23448,28.23448,0,0,1,9.45947,23.396Z" transform="translate(-165.00003 -189.93073)" fill="<?php echo $secondaryColor ?>" />
                    <path d="M754.35439,448.1812,721.01772,441.418l15.62622-37.02978a13.99723,13.99723,0,0,1,27.10571,6.99755Z" transform="translate(-165.00003 -189.93073)" fill="<?php echo $secondaryColor ?>" />
                    <path d="M797.05043,460.73882l-2.00415-45.94141c-1.51977-8.63623,3.42408-16.80029,11.02735-18.13476,7.60547-1.32959,15.03174,4.66016,16.55835,13.35986l7.533,42.92774Z" transform="translate(-165.00003 -189.93073)" fill="<?php echo $secondaryColor ?>" />
